...
| ---- | ------------------------------------------------------------------------------- | ------ |
| -1   | [Behind the 900 stars repository - Slide][part-1]                               | Выполнено   |
| 00   | [Prerequisites][part00]                                                         | Выполнено   |
| 01   | [Create a new repository and set up a new Angular application with CLI][part01] | Выполнено   |
| 02   | [Build the application layout with flex and TailwindCSS][part02]                | Выполнено   |
| 03   | [Setup Akita state management][part03]                                          | Выполнено   |
| 04   | [Build an editable textbox][part04]                                             | Выполнено   |
| 05   | [Build an interactive drag and drop board][part05]                              | Выполнено   |
| 06   | [Build a markdown text editor][part06]                                          | Выполнено   |
| 07   | [Build a rich text HTML editor][part07]                                         | Выполнено   |
| 08   | [Create placeholder loading (like Facebook's cards loading)][part08]            | Выполнено   |
